...
#   Mayor.create(name: 'Emanuel', city: cities.first)
	...
	# Users
	User.create!(first_name: "Andy", last_name: "Murphy", email: "andy@andy.com", password: "ok123456", city: "Austin", state: "TX", country: "USA", image: "https://fbcdn-sphotos-d-a.akamaihd.net/hphotos-ak-ash3/882510_1778254706338_724871419_o.jpg")
	...
	User.create!(first_name: "Shehzan", last_name: "Devani ", email: "nasty@nasty.com", password: "ok123456", city: "Austin", state: "TX", country: "USA", image: "https://fbcdn-sphotos-g-a.akamaihd.net/hphotos-ak-ash2/819408_10151378874079699_689397579_o.jpg")
  ...
  # Rides
  Ride.create!(title: "Shizzy's New Bugatti", origin: "Austin", departure_time_local: "2014-06-11 00:00:00 UTC", max_seats: 4, image: "http://files.sharenator.com/funny_car_photo_cat_vehicle-s400x300-12996-580.jpg", price_per_seat: "38", event_id: 1, user_id: 2)
  Ride.create!(title: "Kendra's Mizzou Van", origin: "Austin", departure_time_local: "2014-06-10 00:00:00 UTC", max_seats: 3, image: "http://sfcitizen.com/blog/wp-content/uploads/2008/07/img_8977-copy.jpg", price_per_seat: "89", event_id: 1, user_id: 4)
  Ride.create!(title: "Gamble's Lumberjack Truck", origin: "Austin", departure_time_local: "2014-06-10 00:00:00 UTC", max_seats: 3, image: "http://whirledview.typepad.com/.a/6a00d834515f8469e2015433201b1c970c-pi", price_per_seat: "22", event_id: 1, user_id: 7)

  # Seats
  Seat.create!(user_id: 5, ride_id: 1)
  Seat.create!(user_id: 2, ride_id: 3)
  Seat.create!(user_id: 8, ride_id: 1)
